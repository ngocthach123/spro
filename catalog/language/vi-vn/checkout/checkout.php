...
$_['text_agree']                     = 'Tôi đã đọc và đồng ý với điều khoản <a class="agree" href="%s"><b>%s</b></a>';
$_['text_address_new']               = 'Dùng địa chỉ thanh toán mới';
$_['text_address_existing']          = 'Dùng địa chỉ thanh toán đã có';
...
$_['text_recurring_item']            = 'Sản phẩm tính kỳ';
...
$_['text_payment_cancel'] = '%s mỗi %d %s(s) cho đến khi hủy bỏ';
...
$_['error_attempts']                 = 'Cảnh báo: Tài khoản của bạn đã vượt quá số lượng cho phép của phần đăng nhập. Vui lòng thử lại trong 1 giờ.';
...
$_['error_city']                     = 'Vui lòng chọn quận / huyện!';
...
$_['error_custom_field_validate']    = '%s không hợp lệ!';