...
class ControllerReviewStoreReview extends Controller
{
    ...
    public function index()
    {
        ...
        if(VERSION>='2.2.0.0'){
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_theme') . '/template/review/store_review.tpl')) {
                $this->response->setOutput($this->load->view($this->config->get('config_theme') . '/template/review/store_review.tpl', $data));
            } else {
    ...
    public function review() {
        ...
        if(VERSION>='2.2.0.0'){
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_theme') . '/template/review/store_review_list.tpl')) {
                $this->response->setOutput($this->load->view($this->config->get('config_theme') . '/template/review/store_review_list.tpl', $data));
            } else {
