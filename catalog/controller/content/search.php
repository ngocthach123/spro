...
class ControllerNewsSearch extends Controller {     
    public function index() { 
        ...
        $categories_1 = $this->model_content_cat->getCategories(0);

        foreach ($categories_1 as $category_1) {
            $level_2_data = array();
            
            $categories_2 = $this->model_content_cat->getCategories($category_1['cat_id']);
            
            foreach ($categories_2 as $category_2) {
                $level_3_data = array();
                
                $categories_3 = $this->model_content_cat->getCategories($category_2['cat_id']);
                
                foreach ($categories_3 as $category_3) {
                    $level_3_data[] = array(
                        'category_id' => $category_3['catid'],
                        'name'        => $category_3['name'],
                    );
                }
                
                $level_2_data[] = array(
                    'category_id' => $category_2['cat_id'],    
        ...
        if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_tag'])) {
            ...
            $new_total = $this->model_content_news->getTotalnewss($data);
