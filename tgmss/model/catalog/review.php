...
class ModelCatalogReview extends Model {
	...
	// Get Reviews with status disible
	public function getReviewsDisble($data = array()) {
		$sql = "SELECT r.review_id, pd.name, r.author, r.text, r.rating, r.status, r.date_added FROM " . DB_PREFIX . "review r LEFT JOIN " . DB_PREFIX . "product_description pd ON (r.product_id = pd.product_id) WHERE pd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND r.status = 0";
	...
	// End Get Reviews with status disible
