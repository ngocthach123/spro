      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <input type="text" name="filter_product" value="<?php echo $filter_product; ?>" class="form-control" placeholder="Nhập tên sản phẩm cần tìm kiếm...">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    ...
                    <?php endif;?>
                    <a href="<?php echo $review['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
