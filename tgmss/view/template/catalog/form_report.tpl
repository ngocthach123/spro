...
<body>
    ...
    <table height="143" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td height="30"><strong>CÔNG TY TNHH CÔNG NGHIỆP VÀ THƯƠNG MẠI NAM VIỆT</strong></td>
        </tr>
        <tr>
            <td height="20">Địa chỉ: 143 Bình Lợi, Phường 13, Quận Bình  Thạnh, TP. Hồ Chí Minh</td>
        </tr>
        <tr>
            <td height="20">Điện thoại: 08 - 35 534 298    Fax: 08 - 35 534 310</td>
        </tr>
        <tr>
            <td height="20">Website: <a href="http://spro.vn">http://spro.vn</a> –  Email: hotrospro@gmail.com</td>
        </tr>
    </table>
    ...
    <table border="1" cellspacing="0">
        ...
        <?php $i = 1; foreach($products as $product):?>
            <tr>
                ...
                <td width="200"><?php echo $product['description'];?></td>
