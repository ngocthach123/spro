  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="well hidden">
          ...
          <div class="col-md-3 wrap-catnav">
              <?php foreach ($categories as $category) { ?>
              <div class="nav-block">
                  <a href="<?php echo $category['href']; ?>" class="a-lv1 list-group-item th catenamehome <?php if ($category['category_id'] == $category_id) echo 'active'?>" >
                      <?php if ($category['children']): ?> <span class="nav-plus"><i class="fa fa-plus" aria-hidden="true"></i></span> <?php endif?>
    ...
    <script>
        $(".nav-plus").click(function(e){
            e.preventDefault();
            $(this).parent().parent().find("ul.ul-lv2").slideToggle('fast').show();
