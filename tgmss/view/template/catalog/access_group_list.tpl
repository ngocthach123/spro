        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-option">
          <div class="table-responsive">
            <table class="table table-hover">
              ...
              <tbody>
                <?php if ($access_groups) { ?>
                <?php foreach ($access_groups as $access_group) { ?>
                <tr>
                  <td class="text-center">
                    <input type="checkbox" name="selected[]" value="<?php echo $access_group['group_id']; ?>" />
                 </td>
                  <td class="text-left"><?php echo $access_group['name']; ?></td>
                  <td class="text-right"><a href="<?php echo $access_group['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
