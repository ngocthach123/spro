  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a onclick="$('#apply').attr('value', '1'); $('#form-sr-lite').submit();" data-toggle="tooltip" title="<?php echo $button_apply; ?>" class="btn btn-success"><i class="fa fa-refresh"></i></a>
        <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
      <h1><span class="iconfa"><i class="fa fa-credit-card"></i></span> <i class="fa fa-comments"></i> <?php echo $heading_title; ?><div class="dev-name">by vanstudio</div></h1>
      <ul class="breadcrumb">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sr-lite" class="form-horizontal">
    ...
    function getNotifications() {
      ...
      setTimeout(
              function(){
                $.ajax({
                  type: 'GET',
                  url: 'index.php?route=module/storereview/getNotifications&token=<?php echo $token; ?>',
                  dataType: 'json',
