    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-slideshow" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-left"><?php echo $entry_left; ?></label>
            <div class="col-sm-10">
              <input type="text" name="left" value="<?php echo $left; ?>" placeholder="<?php echo $entry_left; ?>" id="input-left" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-bottom"><?php echo $entry_bottom; ?></label>
            <div class="col-sm-10">
              <input type="text" name="bottom" value="<?php echo $bottom; ?>" placeholder="<?php echo $entry_bottom; ?>" id="input-bottom" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-right"><?php echo $entry_right; ?></label>
            <div class="col-sm-10">
              <input type="text" name="right" value="<?php echo $right; ?>" placeholder="<?php echo $entry_right; ?>" id="input-right" class="form-control" />
            </div>
          </div>
          <div class="form-group">
