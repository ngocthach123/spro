...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    <?php if ($logged) { ?>
    <a type="button" id="button-menu" class="pull-left hidden"><i class="fa fa-indent fa-lg"></i></a>
    <?php } ?>
  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown hidden"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-home fa-lg"></i></a>
    ...
    <li class="dropdown hidden"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://tgmss.com/" target="_blank"><?php echo $text_homepage; ?></a></li>
        <li><a href="http://tgmss.com/" target="_blank"><?php echo $text_documentation; ?></a></li>
        <li><a href="http://tgmss.com/" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
    <li><a href="<?php echo $logout; ?>"><i class="fa fa-unlock fa-lg"></i>&nbsp;&nbsp; <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_logout; ?></span></a></li>
  </ul>
  <?php } ?>
</header>
